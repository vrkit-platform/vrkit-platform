...
// @generated from protobuf file "LapTrajectory.proto" (package "VRKit.Models", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message VRKit.Models.LapTrajectory
 */
export interface LapTrajectory {
    /**
     * @generated from protobuf field: VRKit.Models.LapTrajectory.Metadata metadata = 1;
     */
    metadata?: LapTrajectory_Metadata;
    /**
     * @generated from protobuf field: VRKit.Models.TrackLayoutMetadata track_layout_metadata = 2;
     */
    trackLayoutMetadata?: TrackLayoutMetadata;
    /**
     * @generated from protobuf field: VRKit.Models.FileInfo file_info = 3;
     */
    fileInfo?: FileInfo;
    /**
    ...
    timestamp: bigint;
    /**
     * @generated from protobuf field: repeated VRKit.Models.LapCoordinate path = 20;
     */
    path: LapCoordinate[];
}
/**
 * @generated from protobuf message VRKit.Models.LapTrajectory.Metadata
 */
...
class LapTrajectory$Type extends MessageType<LapTrajectory> {
    constructor() {
        super("VRKit.Models.LapTrajectory", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: LapTrajectory): LapTrajectory {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* VRKit.Models.LapTrajectory.Metadata metadata */ 1:
                    message.metadata = LapTrajectory_Metadata.internalBinaryRead(reader, reader.uint32(), options, message.metadata);
                    break;
                case /* VRKit.Models.TrackLayoutMetadata track_layout_metadata */ 2:
    ...
    internalBinaryWrite(message: LapTrajectory, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* VRKit.Models.FileInfo file_info = 3; */
        if (message.fileInfo)
        ...
        /* repeated VRKit.Models.LapCoordinate path = 20; */
...
/**
 * @generated MessageType for protobuf message VRKit.Models.LapTrajectory
 */
...
class LapTrajectory_Metadata$Type extends MessageType<LapTrajectory_Metadata> {
    constructor() {
        super("VRKit.Models.LapTrajectory.Metadata", [
...
/**
 * @generated MessageType for protobuf message VRKit.Models.LapTrajectory.Metadata
 */
