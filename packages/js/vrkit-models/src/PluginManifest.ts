...
export interface PluginUserSettingValue {
    ...
    id: string;
    /**
     * @generated from protobuf field: IRacingTools.Models.PluginUserSettingType type = 2;
     */
...
export interface PluginComponentDefinition {
    ...
    /**
     * @generated from protobuf field: IRacingTools.Models.PluginOverview overview = 8;
     */
...
class PluginUserSettingValue$Type extends MessageType<PluginUserSettingValue> {
    constructor() {
        super("IRacingTools.Models.PluginUserSettingValue", [
            ...
            { no: 2, name: "type", kind: "enum", T: () => ["IRacingTools.Models.PluginUserSettingType", PluginUserSettingType, "PLUGIN_USER_SETTING_TYPE_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    ...
                    break;
                case /* IRacingTools.Models.PluginUserSettingType type */ 2:
    ...
    internalBinaryWrite(message: PluginUserSettingValue, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* IRacingTools.Models.PluginUserSettingType type = 2; */
        if (message.type !== 0)
