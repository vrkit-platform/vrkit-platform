...
// @generated from protobuf file "OverlayTypes.proto" (package "IRacingTools.Models", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message IRacingTools.Models.OverlayBaseSettings
 */
...
/**
 * @generated from protobuf message IRacingTools.Models.OverlayInfo
 */
export interface OverlayInfo {
    ...
    id: string;
    /**
     * @generated from protobuf field: IRacingTools.Models.OverlayKind kind = 2;
     */
    kind: OverlayKind;
    /**
     ...
     *
     * @generated from protobuf field: map<string, IRacingTools.Models.PluginUserSettingValue> user_setting_values = 30;
     */
    userSettingValues: {
        [key: string]: PluginUserSettingValue;
    };
    /**
     * @generated from protobuf field: IRacingTools.Models.OverlayBaseSettings settings = 40;
     */
    settings?: OverlayBaseSettings;
}
/**
 * @generated from protobuf message IRacingTools.Models.OverlayPlacement
 */
...
/**
 * @generated from protobuf message IRacingTools.Models.OverlayConfig
 */
export interface OverlayConfig {
    /**
     * @generated from protobuf field: IRacingTools.Models.OverlayInfo overlay = 1;
     */
    overlay?: OverlayInfo;
    /**
     * @generated from protobuf field: IRacingTools.Models.OverlayPlacement placement = 2;
     */
...
/**
 * @generated from protobuf enum IRacingTools.Models.OverlayAnchor
 */
...
/**
 * @generated from protobuf enum IRacingTools.Models.OverlayKind
 */
...
class OverlayBaseSettings$Type extends MessageType<OverlayBaseSettings> {
    constructor() {
        super("IRacingTools.Models.OverlayBaseSettings", [
...
/**
 * @generated MessageType for protobuf message IRacingTools.Models.OverlayBaseSettings
 */
export const OverlayBaseSettings = new OverlayBaseSettings$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OverlayInfo$Type extends MessageType<OverlayInfo> {
    constructor() {
        super("IRacingTools.Models.OverlayInfo", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "kind", kind: "enum", T: () => ["IRacingTools.Models.OverlayKind", OverlayKind, "OVERLAY_KIND_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    ...
                    break;
                case /* IRacingTools.Models.OverlayKind kind */ 2:
                ...
                case /* repeated string data_var_names */ 20:
                    ...
                    break;
                case /* map<string, IRacingTools.Models.PluginUserSettingValue> user_setting_values */ 30:
                    this.binaryReadMap30(message.userSettingValues, reader, options);
                    break;
                case /* IRacingTools.Models.OverlayBaseSettings settings */ 40:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for field IRacingTools.Models.OverlayInfo.user_setting_values");
            }
        }
    ...
    internalBinaryWrite(message: OverlayInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* IRacingTools.Models.OverlayKind kind = 2; */
        if (message.kind !== 0)
        ...
        /* map<string, IRacingTools.Models.PluginUserSettingValue> user_setting_values = 30; */
        ...
        /* IRacingTools.Models.OverlayBaseSettings settings = 40; */
        if (message.settings)
...
/**
 * @generated MessageType for protobuf message IRacingTools.Models.OverlayInfo
 */
export const OverlayInfo = new OverlayInfo$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OverlayPlacement$Type extends MessageType<OverlayPlacement> {
    constructor() {
        super("IRacingTools.Models.OverlayPlacement", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message IRacingTools.Models.OverlayPlacement
 */
export const OverlayPlacement = new OverlayPlacement$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OverlayConfig$Type extends MessageType<OverlayConfig> {
    constructor() {
        super("IRacingTools.Models.OverlayConfig", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: OverlayConfig): OverlayConfig {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* IRacingTools.Models.OverlayInfo overlay */ 1:
                    message.overlay = OverlayInfo.internalBinaryRead(reader, reader.uint32(), options, message.overlay);
                    break;
                case /* IRacingTools.Models.OverlayPlacement placement */ 2:
...
/**
 * @generated MessageType for protobuf message IRacingTools.Models.OverlayConfig
 */
