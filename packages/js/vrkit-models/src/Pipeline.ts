...
// @generated from protobuf file "Pipeline.proto" (package "VRKit.Models", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message VRKit.Models.PipelineLog
 */
export interface PipelineLog {
    /**
     * @generated from protobuf field: VRKit.Models.PipelineLog.Level level = 1;
     */
...
/**
 * @generated from protobuf enum VRKit.Models.PipelineLog.Level
 */
...
/**
 * @generated from protobuf message VRKit.Models.Pipeline
 */
export interface Pipeline {
    ...
    id: string;
    /**
     * @generated from protobuf field: VRKit.Models.PipelineType type = 2;
     */
    type: PipelineType;
    /**
     * @generated from protobuf field: VRKit.Models.PipelineStatus status = 5;
     */
    status: PipelineStatus;
    /**
     * @generated from protobuf field: repeated VRKit.Models.Pipeline.Attempt attempts = 50;
     */
    attempts: Pipeline_Attempt[];
}
/**
 * @generated from protobuf message VRKit.Models.Pipeline.Attempt
 */
export interface Pipeline_Attempt {
    ...
    timestamp: bigint;
    /**
     * @generated from protobuf field: VRKit.Models.PipelineStatus status = 3;
     */
    status: PipelineStatus;
    /**
    ...
    /**
     * @generated from protobuf field: repeated VRKit.Models.PipelineLog logs = 50;
     */
    logs: PipelineLog[];
}
/**
 * @generated from protobuf enum VRKit.Models.PipelineType
 */
...
/**
 * @generated from protobuf enum VRKit.Models.PipelineStatus
 */
...
class PipelineLog$Type extends MessageType<PipelineLog> {
    constructor() {
        super("VRKit.Models.PipelineLog", [
            { no: 1, name: "level", kind: "enum", T: () => ["VRKit.Models.PipelineLog.Level", PipelineLog_Level] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: PipelineLog): PipelineLog {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* VRKit.Models.PipelineLog.Level level */ 1:
    ...
    internalBinaryWrite(message: PipelineLog, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* VRKit.Models.PipelineLog.Level level = 1; */
        if (message.level !== 0)
...
/**
 * @generated MessageType for protobuf message VRKit.Models.PipelineLog
 */
export const PipelineLog = new PipelineLog$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Pipeline$Type extends MessageType<Pipeline> {
    constructor() {
        super("VRKit.Models.Pipeline", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "type", kind: "enum", T: () => ["VRKit.Models.PipelineType", PipelineType, "PIPELINE_TYPE_"] },
            { no: 5, name: "status", kind: "enum", T: () => ["VRKit.Models.PipelineStatus", PipelineStatus, "PIPELINE_STATUS_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    ...
                    break;
                case /* VRKit.Models.PipelineType type */ 2:
                    message.type = reader.int32();
                    break;
                case /* VRKit.Models.PipelineStatus status */ 5:
                    message.status = reader.int32();
                    break;
                case /* repeated VRKit.Models.Pipeline.Attempt attempts */ 50:
    ...
    internalBinaryWrite(message: Pipeline, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* VRKit.Models.PipelineType type = 2; */
        if (message.type !== 0)
            writer.tag(2, WireType.Varint).int32(message.type);
        /* VRKit.Models.PipelineStatus status = 5; */
        if (message.status !== 0)
            writer.tag(5, WireType.Varint).int32(message.status);
        /* repeated VRKit.Models.Pipeline.Attempt attempts = 50; */
...
/**
 * @generated MessageType for protobuf message VRKit.Models.Pipeline
 */
export const Pipeline = new Pipeline$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Pipeline_Attempt$Type extends MessageType<Pipeline_Attempt> {
    constructor() {
        super("VRKit.Models.Pipeline.Attempt", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "timestamp", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "status", kind: "enum", T: () => ["VRKit.Models.PipelineStatus", PipelineStatus, "PIPELINE_STATUS_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 timestamp */ 2:
                    ...
                    break;
                case /* VRKit.Models.PipelineStatus status */ 3:
                    message.status = reader.int32();
                    break;
                case /* int32 attempt_number */ 10:
                    message.attemptNumber = reader.int32();
                    break;
                case /* repeated VRKit.Models.PipelineLog logs */ 50:
...
/**
 * @generated MessageType for protobuf message VRKit.Models.Pipeline.Attempt
 */
