...
// @generated from protobuf file "TrackMapFile.proto" (package "VRKit.Models", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message VRKit.Models.TrackMapFile
 */
export interface TrackMapFile {
    ...
    /**
     * @generated from protobuf field: VRKit.Models.FileInfo file_info = 2;
     */
    fileInfo?: FileInfo;
}
...
class TrackMapFile$Type extends MessageType<TrackMapFile> {
    constructor() {
        super("VRKit.Models.TrackMapFile", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* VRKit.Models.TrackLayoutMetadata track_layout_metadata */ 1:
                    ...
                    break;
                case /* VRKit.Models.FileInfo file_info */ 2:
    ...
    internalBinaryWrite(message: TrackMapFile, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* VRKit.Models.FileInfo file_info = 2; */
        if (message.fileInfo)
...
/**
 * @generated MessageType for protobuf message VRKit.Models.TrackMapFile
 */
