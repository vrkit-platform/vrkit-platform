...
// @generated from protobuf file "UIResource.proto" (package
...
import { ColorFormat, ImageFormat } from "./GraphicsTypes"
...
export interface UIImageResource {
    /**
     * @generated from protobuf field: IRacingTools.Models.ImageFormat format =
     *     1;
     */
    format: ImageFormat;
    /**
...
export interface UIColorResource {
    /**
     * @generated from protobuf field: IRacingTools.Models.ColorFormat format =
     *     1;
     */
    format: ColorFormat;
    /**
...
export interface UIResource {
    /**
     * @generated from protobuf field: IRacingTools.Models.UIColorResource
     *     color = 10;
     */
    color?: UIColorResource;
    /**
     * @generated from protobuf field: IRacingTools.Models.UIImageResource icon
     *     = 20;
     */
...
class UIResource$Type extends MessageType<UIResource> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UIResource): UIResource {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* IRacingTools.Models.UIColorResource color */ 10:
                    message.color = UIColorResource.internalBinaryRead(reader, reader.uint32(), options, message.color);
                    break;
                case /* IRacingTools.Models.UIImageResource icon */ 20:
