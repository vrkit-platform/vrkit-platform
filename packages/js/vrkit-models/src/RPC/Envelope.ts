...
// @generated from protobuf file "RPC/Envelope.proto" (package "VRKit.Models.RPC", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message VRKit.Models.RPC.Envelope
 */
export interface Envelope {
    ...
    sourceId: string;
    /**
     * @generated from protobuf field: VRKit.Models.RPC.Envelope.Kind kind = 3;
     */
    kind: Envelope_Kind;
    /**
     * @generated from protobuf field: VRKit.Models.RPC.Envelope.Status status = 4;
     */
...
/**
 * @generated from protobuf enum VRKit.Models.RPC.Envelope.Kind
 */
...
/**
 * @generated from protobuf enum VRKit.Models.RPC.Envelope.Status
 */
...
class Envelope$Type extends MessageType<Envelope> {
    constructor() {
        super("VRKit.Models.RPC.Envelope", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "source_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "kind", kind: "enum", T: () => ["VRKit.Models.RPC.Envelope.Kind", Envelope_Kind, "KIND_"] },
            { no: 4, name: "status", kind: "enum", T: () => ["VRKit.Models.RPC.Envelope.Status", Envelope_Status, "STATUS_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string source_id */ 2:
                    ...
                    break;
                case /* VRKit.Models.RPC.Envelope.Kind kind */ 3:
                    message.kind = reader.int32();
                    break;
                case /* VRKit.Models.RPC.Envelope.Status status */ 4:
    ...
    internalBinaryWrite(message: Envelope, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* VRKit.Models.RPC.Envelope.Kind kind = 3; */
        if (message.kind !== 0)
            writer.tag(3, WireType.Varint).int32(message.kind);
        /* VRKit.Models.RPC.Envelope.Status status = 4; */
        if (message.status !== 0)
...
/**
 * @generated MessageType for protobuf message VRKit.Models.RPC.Envelope
 */
