import type { IChatMessage, IChatParticipant, IChatConversation } from 'vrkit-app-renderer/types/chat';

import { useMemo } from 'react';
import useSWR, { mutate } from 'swr';

import { keyBy } from 'vrkit-app-renderer/utils/helper';
import axios, { fetcher, endpoints } from 'vrkit-app-renderer/utils/axios';
