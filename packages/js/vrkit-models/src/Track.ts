...
// @generated from protobuf file "Track.proto" (package "VRKit.Models", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message VRKit.Models.Track
 */
export interface Track {
     ...
     *
     * @generated from protobuf field: VRKit.Models.TrackType type = 3;
     */
    type: TrackType;
    /**
    ...
    /**
     * @generated from protobuf field: repeated VRKit.Models.Track.Layout layouts = 60;
     */
    layouts: Track_Layout[];
}
/**
 * @generated from protobuf message VRKit.Models.Track.Layout
 */
...
class Track$Type extends MessageType<Track> {
    constructor() {
        super("VRKit.Models.Track", [
            { no: 1, name: "id", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "type", kind: "enum", T: () => ["VRKit.Models.TrackType", TrackType, "TRACK_TYPE_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string name */ 2:
                    ...
                    break;
                case /* VRKit.Models.TrackType type */ 3:
                ...
                case /* int32 pit_speed_limit */ 50:
                    ...
                    break;
                case /* repeated VRKit.Models.Track.Layout layouts */ 60:
    ...
    internalBinaryWrite(message: Track, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated VRKit.Models.Track.Layout layouts = 60; */
...
/**
 * @generated MessageType for protobuf message VRKit.Models.Track
 */
export const Track = new Track$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Track_Layout$Type extends MessageType<Track_Layout> {
    constructor() {
        super("VRKit.Models.Track.Layout", [
...
/**
 * @generated MessageType for protobuf message VRKit.Models.Track.Layout
 */
