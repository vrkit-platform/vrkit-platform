...
// @generated from protobuf file "ScreenConfig.proto" (package "VRKit.Models", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message VRKit.Models.DisplayConfig
 */
export interface DisplayConfig {
    ...
    primary: boolean;
    /**
     * @generated from protobuf field: VRKit.Models.SizeI physical_size = 10;
     */
    physicalSize?: SizeI;
    /**
    ...
    scale: number;
    /**
     * @generated from protobuf field: VRKit.Models.SizeI scaled_size = 21;
     */
    scaledSize?: SizeI;
    /**
     * @generated from protobuf field: VRKit.Models.RectI scaled_rect = 22;
     */
    scaledRect?: RectI;
}
/**
 * @generated from protobuf message VRKit.Models.DisplayLayoutConfig
 */
export interface DisplayLayoutConfig {
    /**
     * @generated from protobuf field: VRKit.Models.PositionI origin = 1;
     */
    origin?: PositionI;
    /**
     * @generated from protobuf field: VRKit.Models.PositionI origin_offset = 2;
     */
    originOffset?: PositionI;
    /**
     * @generated from protobuf field: repeated VRKit.Models.DisplayConfig displays = 5;
     */
    displays: DisplayConfig[];
}
/**
 * @generated from protobuf message VRKit.Models.VRLayoutConfig
 */
export interface VRLayoutConfig {
    ...
    scale: number;
    /**
     * @generated from protobuf field: VRKit.Models.SizeI scaled_size = 11;
     */
    scaledSize?: SizeI;
}
/**
 ...
 *
 * @generated from protobuf message VRKit.Models.ScreenConfig
 */
export interface ScreenConfig {
    ...
    name: string;
    /**
     * @generated from protobuf field: VRKit.Models.SizeI size = 6;
     */
    size?: SizeI;
    /**
     * @generated from protobuf field: VRKit.Models.DisplayLayoutConfig layout_display = 10;
     */
    layoutDisplay?: DisplayLayoutConfig;
    /**
     * @generated from protobuf field: VRKit.Models.VRLayoutConfig layout_vr = 11;
     */
...
class DisplayConfig$Type extends MessageType<DisplayConfig> {
    constructor() {
        super("VRKit.Models.DisplayConfig", [
    ...
    internalBinaryWrite(message: DisplayConfig, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* VRKit.Models.SizeI physical_size = 10; */
        ...
        /* VRKit.Models.SizeI scaled_size = 21; */
        ...
        /* VRKit.Models.RectI scaled_rect = 22; */
...
class DisplayLayoutConfig$Type extends MessageType<DisplayLayoutConfig> {
    ...
    internalBinaryWrite(message: DisplayLayoutConfig, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated VRKit.Models.DisplayConfig displays = 5; */
...
/**
 * @generated MessageType for protobuf message VRKit.Models.DisplayLayoutConfig
 */
...
class VRLayoutConfig$Type extends MessageType<VRLayoutConfig> {
    constructor() {
        super("VRKit.Models.VRLayoutConfig", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* double scale */ 10:
                    message.scale = reader.double();
                    break;
                case /* VRKit.Models.SizeI scaled_size */ 11:
                    message.scaledSize = SizeI.internalBinaryRead(reader, reader.uint32(), options, message.scaledSize);
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: VRLayoutConfig, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* VRKit.Models.SizeI scaled_size = 11; */
        if (message.scaledSize)
...
class ScreenConfig$Type extends MessageType<ScreenConfig> {
    ...
    internalBinaryWrite(message: ScreenConfig, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* VRKit.Models.VRLayoutConfig layout_vr = 11; */
        if (message.layoutVr)
...
/**
 * @generated MessageType for protobuf message VRKit.Models.ScreenConfig
 */
