import "jest"
import { SizeI, VRLayout } from "@vrkit-platform/models"
import { ConvertScreenRectToVRLayout, ConvertVRLayoutToScreenRect, VRLayoutBoundsDiameter } from "./VRLayoutHelpers"
...
describe("VRLayoutHelpers", () => {
  ...
  it("should convert VRLayout to screen rect and back to original VRLayout", () => {
    for (const srcVRLayout of kVRLayouts) {
      ...
      expect(screenRect.size.width).toBe(srcVRLayout.size.width * (kSurfaceSize.width / VRLayoutBoundsDiameter)) // 3-4-5 triangle
