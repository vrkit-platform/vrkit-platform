...
namespace IRacingTools::App::Models {
  ...
  public:
    ...
    explicit AppCameraInfo(const IRacingTools::SDK::SessionInfo::CameraInfo &value = {}, QObject *parent = nullptr)
        : QObject(parent), groups(ToQList<Group, QSharedPointer<AppGroup>>(value.groups, this)){};
  ...
  public:
    ...
    explicit AppDriverInfo(const IRacingTools::SDK::SessionInfo::DriverInfo &value = {}, QObject *parent = nullptr)
        : QObject(parent), driverCarIdx(value.driverCarIdx), driverUserID(value.driverUserID),
          ...
          drivers(ToQList<Driver, QSharedPointer<AppDriver>>(value.drivers, this)){};
  ...
  public:
    ...
    explicit AppGroup(const IRacingTools::SDK::SessionInfo::Group &value = {}, QObject *parent = nullptr)
        : QObject(parent), groupNum(value.groupNum), groupName(QString::fromStdString(value.groupName)),
          cameras(ToQList<Camera, QSharedPointer<AppCamera>>(value.cameras, this)), isScenic(value.isScenic){};
  ...
  public:
    ...
    explicit AppQualifyResultsInfo(const IRacingTools::SDK::SessionInfo::QualifyResultsInfo &value = {},
                                   QObject *parent = nullptr)
        : QObject(parent), results(ToQList<SessionResult, QSharedPointer<AppSessionResult>>(value.results, this)){};
  ...
  public:
    ...
    explicit AppRadio(const IRacingTools::SDK::SessionInfo::Radio &value = {}, QObject *parent = nullptr)
        : QObject(parent), radioNum(value.radioNum), hopCount(value.hopCount), numFrequencies(value.numFrequencies),
          ...
          frequencies(ToQList<Frequency, QSharedPointer<AppFrequency>>(value.frequencies, this)){};
  ...
  public:
    ...
    explicit AppRadioInfo(const IRacingTools::SDK::SessionInfo::RadioInfo &value = {}, QObject *parent = nullptr)
        : QObject(parent), selectedRadioNum(value.selectedRadioNum),
          radios(ToQList<Radio, QSharedPointer<AppRadio>>(value.radios, this)){};
  ...
  public:
    ...
    explicit AppSession(const IRacingTools::SDK::SessionInfo::Session &value = {}, QObject *parent = nullptr)
        : QObject(parent), sessionNum(value.sessionNum), sessionLaps(QString::fromStdString(value.sessionLaps)),
          ...
          resultsPositions(
              ToQList<ResultsPosition, QSharedPointer<AppResultsPosition>>(value.resultsPositions, this)),
          resultsFastestLap(
              ToQList<ResultsFastestLap, QSharedPointer<AppResultsFastestLap>>(value.resultsFastestLap, this)),
  ...
  public:
    ...
    explicit AppSessionInfo(const IRacingTools::SDK::SessionInfo::SessionInfo &value = {}, QObject *parent = nullptr)
        : QObject(parent), sessions(ToQList<Session, QSharedPointer<AppSession>>(value.sessions, this)){};
  ...
  public:
    ...
    explicit AppSplitTimeInfo(const IRacingTools::SDK::SessionInfo::SplitTimeInfo &value = {},
                              QObject *parent = nullptr)
        : QObject(parent), sectors(ToQList<Sector, QSharedPointer<AppSector>>(value.sectors, this)){};
  ...
  public:
    ...
    explicit AppTiresAero(const IRacingTools::SDK::SessionInfo::TiresAero &value = {}, QObject *parent = nullptr)
        : QObject(parent), leftFrontTire(QSharedPointer<AppTire>::create(value.leftFrontTire, this)),
          leftRearTire(QSharedPointer<AppTire>::create(value.leftRearTire, this)),
          rightFrontTire(QSharedPointer<AppTire>::create(value.rightFrontTire, this)),
          rightRearTire(QSharedPointer<AppTire>::create(value.rightRearTire, this)),
          aeroSettings(QSharedPointer<AppAeroSettings>::create(value.aeroSettings, this)){};
  ...
  public:
    ...
    explicit AppBrakesDriveUnit(const IRacingTools::SDK::SessionInfo::BrakesDriveUnit &value = {},
                                QObject *parent = nullptr)
        : QObject(parent), brakeSpec(QSharedPointer<AppBrakeSpec>::create(value.brakeSpec, this)),
          fuel(QSharedPointer<AppFuel>::create(value.fuel, this)),
          engine(QSharedPointer<AppEngine>::create(value.engine, this)),
          gearRatios(QSharedPointer<AppGearRatio>::create(value.gearRatios, this)){};
  ...
  public:
    ...
    explicit AppChassis(const IRacingTools::SDK::SessionInfo::Chassis &value = {}, QObject *parent = nullptr)
        : QObject(parent), front(QSharedPointer<AppFront>::create(value.front, this)),
          leftFront(QSharedPointer<AppChassisCorner>::create(value.leftFront, this)),
          leftRear(QSharedPointer<AppChassisCorner>::create(value.leftRear, this)),
          rightFront(QSharedPointer<AppChassisCorner>::create(value.rightFront, this)),
          rightRear(QSharedPointer<AppChassisCorner>::create(value.rightRear, this)),
          rear(QSharedPointer<AppRear>::create(value.rear, this)){};
  ...
  public:
    ...
    explicit AppWeekendInfo(const IRacingTools::SDK::SessionInfo::WeekendInfo &value = {}, QObject *parent = nullptr)
        : QObject(parent), trackName(QString::fromStdString(value.trackName)), trackID(value.trackID),
          ...
          weekendOptions(QSharedPointer<AppWeekendOptions>::create(value.weekendOptions, this)),
          telemetryOptions(QSharedPointer<AppTelemetryOptions>::create(value.telemetryOptions, this)){};
  ...
  public:
    ...
    explicit AppCarSetup(const IRacingTools::SDK::SessionInfo::CarSetup &value = {}, QObject *parent = nullptr)
        : QObject(parent), updateCount(value.updateCount),
          tiresAero(QSharedPointer<AppTiresAero>::create(value.tiresAero, this)),
          chassis(QSharedPointer<AppChassis>::create(value.chassis, this)),
          brakesDriveUnit(QSharedPointer<AppBrakesDriveUnit>::create(value.brakesDriveUnit, this)){};
  ...
  public:
    ...
    explicit AppSessionInfoMessage(const IRacingTools::SDK::SessionInfo::SessionInfoMessage &value = {},
                                   QObject *parent = nullptr)
        : QObject(parent), weekendInfo(QSharedPointer<AppWeekendInfo>::create(value.weekendInfo, this)),
          sessionInfo(QSharedPointer<AppSessionInfo>::create(value.sessionInfo, this)),
          qualifyResultsInfo(QSharedPointer<AppQualifyResultsInfo>::create(value.qualifyResultsInfo, this)),
          cameraInfo(QSharedPointer<AppCameraInfo>::create(value.cameraInfo, this)),
          radioInfo(QSharedPointer<AppRadioInfo>::create(value.radioInfo, this)),
          driverInfo(QSharedPointer<AppDriverInfo>::create(value.driverInfo, this)),
          splitTimeInfo(QSharedPointer<AppSplitTimeInfo>::create(value.splitTimeInfo, this)),
          carSetup(QSharedPointer<AppCarSetup>::create(value.carSetup, this)){};
