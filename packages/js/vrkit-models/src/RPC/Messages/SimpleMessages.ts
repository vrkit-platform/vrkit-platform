...
// @generated from protobuf file "RPC/Messages/SimpleMessages.proto" (package "VRKit.Models.RPC.Messages", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message VRKit.Models.RPC.Messages.PingMessage
 */
...
/**
 * @generated from protobuf message VRKit.Models.RPC.Messages.PongMessage
 */
...
/**
 * @generated from protobuf message VRKit.Models.RPC.Messages.ListMessage
 */
...
class PingMessage$Type extends MessageType<PingMessage> {
    constructor() {
        super("VRKit.Models.RPC.Messages.PingMessage", [
...
/**
 * @generated MessageType for protobuf message VRKit.Models.RPC.Messages.PingMessage
 */
export const PingMessage = new PingMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PongMessage$Type extends MessageType<PongMessage> {
    constructor() {
        super("VRKit.Models.RPC.Messages.PongMessage", [
...
/**
 * @generated MessageType for protobuf message VRKit.Models.RPC.Messages.PongMessage
 */
export const PongMessage = new PongMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ListMessage$Type extends MessageType<ListMessage> {
    constructor() {
        super("VRKit.Models.RPC.Messages.ListMessage", [
...
/**
 * @generated MessageType for protobuf message VRKit.Models.RPC.Messages.ListMessage
 */
