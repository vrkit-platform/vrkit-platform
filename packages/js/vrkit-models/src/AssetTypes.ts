...
// @generated from protobuf file "AssetTypes.proto" (package "VRKit.Models", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message VRKit.Models.Image
 */
export interface Image {
    ...
    url: string;
    /**
     * @generated from protobuf field: VRKit.Models.ImageType type = 2;
     */
    type: ImageType;
    /**
     * @generated from protobuf field: VRKit.Models.SizeI size = 10;
     */
    size?: SizeI;
    /**
     * @generated from protobuf field: VRKit.Models.PositionI position = 11;
     */
    position?: PositionI;
}
/**
 * @generated from protobuf enum VRKit.Models.ImageType
 */
...
class Image$Type extends MessageType<Image> {
    constructor() {
        super("VRKit.Models.Image", [
            { no: 1, name: "url", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "type", kind: "enum", T: () => ["VRKit.Models.ImageType", ImageType] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string url */ 1:
                    ...
                    break;
                case /* VRKit.Models.ImageType type */ 2:
                    message.type = reader.int32();
                    break;
                case /* VRKit.Models.SizeI size */ 10:
                    message.size = SizeI.internalBinaryRead(reader, reader.uint32(), options, message.size);
                    break;
                case /* VRKit.Models.PositionI position */ 11:
...
/**
 * @generated MessageType for protobuf message VRKit.Models.Image
 */
