import type { ICalendarFilters } from 'vrkit-app-renderer/types/calendar';
...
import { chipProps, FiltersBlock, FiltersResult } from 'vrkit-app-renderer/components/filters-result';
