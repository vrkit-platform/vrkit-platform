...
// @generated from protobuf file "PluginManifest.proto" (package
// "IRacingTools.Models", syntax proto3) tslint:disable
import type {
  BinaryReadOptions,
  BinaryWriteOptions,
  IBinaryReader,
...
import {
  MessageType, reflectionMergePartial, UnknownFieldHandler, WireType
} from "@protobuf-ts/runtime"
import { UIImageResource, UIResource } from "./UIResource"
...
export interface PluginComponentDefinition {
    ...
    id: string;
    /**
     * @generated from protobuf field: IRacingTools.Models.PluginComponentType
     *     type = 2;
     */
    ...
    description: string;
    /**
     * @generated from protobuf field: IRacingTools.Models.UIResource
     *     ui_resource = 7;
     */
    uiResource?: UIResource;
    /**
     * @generated from protobuf field: IRacingTools.Models.PluginOverview
     *     overview = 8;
     */
    overview?: PluginOverview;
    /**
     * @generated from protobuf field: repeated
     *     IRacingTools.Models.SupportedGame supported_games = 10;
     */
     ...
     *
     * @generated from protobuf field: map<string, string> common_parameters =
     *     15;
     */
    commonParameters: {
        [key: string]: string;
...
export interface PluginComponentDefinition_OverlayCommonSettings {
     ...
     * THIS IS REQUIRED
     *
     * @generated from protobuf field: IRacingTools.Models.SizeI initial_size =
     *     2;
     */
    initialSize?: SizeI;
    /**
...
export interface PluginOverview {
    ...
    /**
     * @generated from protobuf field: repeated
     *     IRacingTools.Models.UIImageResource screenshots = 20;
     */
...
export interface PluginManifest {
    ...
    version: string;
    /**
     * @generated from protobuf field: IRacingTools.Models.PluginOwner owner =
     *     3;
     */
    owner?: PluginOwner;
    /**
    ...
    /**
     * @generated from protobuf field: repeated
     *     IRacingTools.Models.PluginComponentDefinition components = 20;
     */
...
export interface PluginInstall {
    ...
    id: string;
    /**
     * @generated from protobuf field: IRacingTools.Models.PluginInstallStatus
     *     status = 2;
     */
    ...
    manifestFile: string;
    /**
     * @generated from protobuf field: IRacingTools.Models.PluginManifest
     *     manifest = 11;
     */
...
export enum PluginUserSettingType {
    ...
    STRING = 2,
    /**
     * @generated from protobuf enum value: PLUGIN_USER_SETTING_TYPE_BOOLEAN =
     *     3;
     */
    BOOLEAN = 3,
    /**
...
class PluginComponentDefinition$Type extends MessageType<PluginComponentDefinition> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* IRacingTools.Models.UIResource ui_resource */ 7:
                    ...
                    break;
                case /* IRacingTools.Models.PluginOverview overview */ 8:
    ...
    internalBinaryWrite(message: PluginComponentDefinition, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* IRacingTools.Models.PluginOverview overview = 8; */
        if (message.overview)
