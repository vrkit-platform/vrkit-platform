...
import createMixins from "./styles/mixins" // ----------------------------------------------------------------------
...
function createDarkTheme() {
  ...
  const themeOptions:ThemeOptions = {
    ...
    typography: {
      ...typography, // fontFamily: setFont("SanFranciscoDisplay")
    },
    palette: {
      background: {
        default: darkDefault,
        ...
        appBarGradient: appBarBackgroundGradient, ...paneBackgrounds(
          "#1F2025",
          3,
          0.025
        )
      ...
      error: createPaletteChannel({
        contrastText: "#ffffff", main: "#f44336"
      }),
      mode: "dark", ...darkPrimaryAndSecondaryPalettes,
      success: createPaletteChannel({
        contrastText: "#ffffff", main: "#2B993B"
      }),
      info: createPaletteChannel({
        main: "#0a8af3", contrastText: "#ffffff"
      }),
      action: {
        active: actionActive, selected: darken(actionActive, 0.3),
      },
      text: {
      ...
      warning: createPaletteChannel({
        contrastText: "#ffffff", main: "#ff9800"
      })
    },
    components: {
      ...components, AppButton: {
        defaultProps: {}, styles: {}, variants: {
          primary: {
            color: "#ffffff",
...
export function createTheme(): Theme {
   ...
   */
  const theme = muiCreateTheme(createDarkTheme())

  assign(theme, {
    //colorSchemes,
    shadows: shadows(theme.colorScheme),
    customShadows: customShadows(theme.colorScheme),
    direction: "ltr" as Direction,
    typography: {
      ...theme.typography,
      ...typography
  ...
  theme.mixins = {...(theme.mixins ?? {}), ...createMixins(theme)}
  return theme
