...
namespace IRacingTools::Shared::Graphics {
  ...
  DX11TrackMapResources::DX11TrackMapResources(const std::shared_ptr<DXResources> &resources) : resources_(resources) {
  }

  void DX11TrackMapResources::render(const std::shared_ptr<RenderTarget> &target) {
    static float t = 0.0f;
  ...
  HRESULT DX11TrackMapResources::createResources(const std::shared_ptr<RenderTarget> &target) {
