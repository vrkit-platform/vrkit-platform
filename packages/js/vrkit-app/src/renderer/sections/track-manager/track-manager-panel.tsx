...
export interface TrackManagerPanelProps extends StackProps {
  title: string
  link?: string
  subtitle?: string
  collapse?: boolean
...
export function TrackManagerPanel({ sx, link, title, onOpen, subtitle, collapse, onCollapse, ...other }: TrackManagerPanelProps) {
  return (
    <Stack
      direction="row"
      alignItems="center"
