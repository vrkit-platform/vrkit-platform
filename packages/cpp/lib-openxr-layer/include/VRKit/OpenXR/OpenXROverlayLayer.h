...
#include <VRKit/Shared/Timer.h>
#include <VRKit/Shared/UI/ViewerWindowRenderer.h>
...
namespace VRKit::OpenXR {
    ...
    public:
        ...
        OpenXROverlayLayer() = delete;
        OpenXROverlayLayer(XrInstance, XrSystemId, XrSession, OpenXRRuntimeID, const std::shared_ptr<OpenXRNext>&);
        virtual ~OpenXROverlayLayer();

        XrResult xrEndFrame(XrSession session, const XrFrameEndInfo* frameEndInfo);

        std::vector<OpenXROverlayLayer::OverlayFrame> getOverlays(const SHM::Snapshot& snapshot, const Pose& hmdPose);
    ...
    namespace DX11 {
        class OpenXRDX11OverlayLayer final : public OpenXROverlayLayer {
        public:
            OpenXRDX11OverlayLayer(
                XrInstance,
                XrSystemId,
                XrSession,
                OpenXRRuntimeID,
            ...
            virtual ~OpenXRDX11OverlayLayer() override;
