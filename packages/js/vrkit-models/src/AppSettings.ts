...
// @generated from protobuf file "AppSettings.proto" (package "VRKit.Models", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message VRKit.Models.AppSettings
 */
export interface AppSettings {
    ...
    /**
     * @generated from protobuf field: VRKit.Models.ThemeType theme_type = 2;
     */
    themeType: ThemeType;
    /**
    ...
    /**
     * @generated from protobuf field: map<string, VRKit.Models.ActionCustomization> action_customizations = 20;
     */
    actionCustomizations: {
        [key: string]: ActionCustomization;
    };
    /**
     * @generated from protobuf field: map<string, VRKit.Models.OverlayAnchor> overlay_anchors = 30;
     */
    overlayAnchors: {
...
/**
 * @generated from protobuf enum VRKit.Models.ThemeType
 */
...
class AppSettings$Type extends MessageType<AppSettings> {
    constructor() {
        super("VRKit.Models.AppSettings", [
            { no: 1, name: "default_dashboard_config_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "theme_type", kind: "enum", T: () => ["VRKit.Models.ThemeType", ThemeType] },
            ...
            { no: 30, name: "overlay_anchors", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "enum", T: () => ["VRKit.Models.OverlayAnchor", OverlayAnchor, "OVERLAY_ANCHOR_"] } }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string default_dashboard_config_id */ 1:
                    ...
                    break;
                case /* VRKit.Models.ThemeType theme_type */ 2:
                ...
                case /* bool open_dashboard_on_launch */ 11:
                    ...
                    break;
                case /* map<string, VRKit.Models.ActionCustomization> action_customizations */ 20:
                    this.binaryReadMap20(message.actionCustomizations, reader, options);
                    break;
                case /* map<string, VRKit.Models.OverlayAnchor> overlay_anchors */ 30:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for field VRKit.Models.AppSettings.action_customizations");
            }
        }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.int32();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field VRKit.Models.AppSettings.overlay_anchors");
            }
        }
        map[key ?? ""] = val ?? 0;
    }
    internalBinaryWrite(message: AppSettings, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* VRKit.Models.ThemeType theme_type = 2; */
        ...
        /* map<string, VRKit.Models.ActionCustomization> action_customizations = 20; */
        ...
        /* map<string, VRKit.Models.OverlayAnchor> overlay_anchors = 30; */
...
/**
 * @generated MessageType for protobuf message VRKit.Models.AppSettings
 */
