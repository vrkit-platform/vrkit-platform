...
// @generated from protobuf file "UIResource.proto" (package "VRKit.Models", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message VRKit.Models.UIImageResource
 */
export interface UIImageResource {
    /**
     * @generated from protobuf field: VRKit.Models.ImageFormat format = 1;
     */
    format: ImageFormat;
    /**
    ...
    isDataUrl: boolean;
    /**
     * @generated from protobuf field: VRKit.Models.SizeI size = 5;
     */
    size?: SizeI;
    /**
...
/**
 * @generated from protobuf message VRKit.Models.UIColorResource
 */
export interface UIColorResource {
    /**
     * @generated from protobuf field: VRKit.Models.ColorFormat format = 1;
     */
    format: ColorFormat;
    /**
...
/**
 * @generated from protobuf message VRKit.Models.UIResource
 */
export interface UIResource {
    /**
     * @generated from protobuf field: VRKit.Models.UIColorResource color = 10;
     */
    color?: UIColorResource;
    /**
     * @generated from protobuf field: VRKit.Models.UIImageResource icon = 20;
     */
...
class UIImageResource$Type extends MessageType<UIImageResource> {
    constructor() {
        super("VRKit.Models.UIImageResource", [
            { no: 1, name: "format", kind: "enum", T: () => ["VRKit.Models.ImageFormat", ImageFormat, "IMAGE_FORMAT_"] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UIImageResource): UIImageResource {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* VRKit.Models.ImageFormat format */ 1:
                ...
                case /* bool is_data_url */ 3:
                    ...
                    break;
                case /* VRKit.Models.SizeI size */ 5:
    ...
    internalBinaryWrite(message: UIImageResource, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* VRKit.Models.ImageFormat format = 1; */
        if (message.format !== 0)
...
/**
 * @generated MessageType for protobuf message VRKit.Models.UIImageResource
 */
export const UIImageResource = new UIImageResource$Type();
// @generated message type with reflection information, may provide speed optimized methods
class UIColorResource$Type extends MessageType<UIColorResource> {
    constructor() {
        super("VRKit.Models.UIColorResource", [
            { no: 1, name: "format", kind: "enum", T: () => ["VRKit.Models.ColorFormat", ColorFormat, "COLOR_FORMAT_"] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UIColorResource): UIColorResource {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* VRKit.Models.ColorFormat format */ 1:
                    message.format = reader.int32();
                    break;
                case /* string data */ 2:
    ...
    internalBinaryWrite(message: UIColorResource, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* VRKit.Models.ColorFormat format = 1; */
        if (message.format !== 0)
            writer.tag(1, WireType.Varint).int32(message.format);
        /* string data = 2; */
        if (message.data !== "")
...
/**
 * @generated MessageType for protobuf message VRKit.Models.UIColorResource
 */
export const UIColorResource = new UIColorResource$Type();
// @generated message type with reflection information, may provide speed optimized methods
class UIResource$Type extends MessageType<UIResource> {
    constructor() {
        super("VRKit.Models.UIResource", [
            { no: 10, name: "color", kind: "message", T: () => UIColorResource },
            { no: 20, name: "icon", kind: "message", T: () => UIImageResource }
        ]);
    }
    ...
    internalBinaryWrite(message: UIResource, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* VRKit.Models.UIColorResource color = 10; */
        if (message.color)
            UIColorResource.internalBinaryWrite(message.color, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
        /* VRKit.Models.UIImageResource icon = 20; */
        if (message.icon)
            UIImageResource.internalBinaryWrite(message.icon, writer.tag(20, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message VRKit.Models.UIResource
 */
