...
// @generated from protobuf file "Geometry.proto" (package "VRKit.Models", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message VRKit.Models.PositionI
 */
...
/**
 * @generated from protobuf message VRKit.Models.PositionF
 */
...
/**
 * @generated from protobuf message VRKit.Models.SizeI
 */
...
/**
 * @generated from protobuf message VRKit.Models.SizeF
 */
...
/**
 * @generated from protobuf message VRKit.Models.RectI
 */
export interface RectI {
    /**
     * @generated from protobuf field: VRKit.Models.SizeI size = 1;
     */
    size?: SizeI;
    /**
     * @generated from protobuf field: VRKit.Models.PositionI position = 2;
     */
    position?: PositionI;
}
/**
 * @generated from protobuf message VRKit.Models.RectF
 */
export interface RectF {
    /**
     * @generated from protobuf field: VRKit.Models.SizeF size = 1;
     */
    size?: SizeF;
    /**
     * @generated from protobuf field: VRKit.Models.PositionF position = 2;
     */
    position?: PositionF;
}
/**
 * @generated from protobuf message VRKit.Models.VRPose
 */
...
/**
 * @generated from protobuf message VRKit.Models.VRLayout
 */
export interface VRLayout {
    /**
     * @generated from protobuf field: VRKit.Models.VRPose pose = 1;
     */
    pose?: VRPose;
    /**
     * @generated from protobuf field: VRKit.Models.SizeF size = 2;
     */
    size?: SizeF;
    /**
...
/**
 * @generated MessageType for protobuf message VRKit.Models.PositionI
 */
export const PositionI = new PositionI$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PositionF$Type extends MessageType<PositionF> {
    constructor() {
        super("VRKit.Models.PositionF", [
...
/**
 * @generated MessageType for protobuf message VRKit.Models.PositionF
 */
export const PositionF = new PositionF$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SizeI$Type extends MessageType<SizeI> {
    constructor() {
        super("VRKit.Models.SizeI", [
...
/**
 * @generated MessageType for protobuf message VRKit.Models.SizeI
 */
export const SizeI = new SizeI$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SizeF$Type extends MessageType<SizeF> {
    constructor() {
        super("VRKit.Models.SizeF", [
...
/**
 * @generated MessageType for protobuf message VRKit.Models.SizeF
 */
export const SizeF = new SizeF$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RectI$Type extends MessageType<RectI> {
    constructor() {
        super("VRKit.Models.RectI", [
...
/**
 * @generated MessageType for protobuf message VRKit.Models.RectI
 */
export const RectI = new RectI$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RectF$Type extends MessageType<RectF> {
    constructor() {
        super("VRKit.Models.RectF", [
...
/**
 * @generated MessageType for protobuf message VRKit.Models.RectF
 */
export const RectF = new RectF$Type();
// @generated message type with reflection information, may provide speed optimized methods
class VRPose$Type extends MessageType<VRPose> {
    constructor() {
        super("VRKit.Models.VRPose", [
            { no: 1, name: "x", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
...
/**
 * @generated MessageType for protobuf message VRKit.Models.VRPose
 */
export const VRPose = new VRPose$Type();
// @generated message type with reflection information, may provide speed optimized methods
class VRLayout$Type extends MessageType<VRLayout> {
    constructor() {
        super("VRKit.Models.VRLayout", [
...
/**
 * @generated MessageType for protobuf message VRKit.Models.VRLayout
 */
