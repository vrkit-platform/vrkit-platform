...
import COLORS from 'vrkit-app-renderer/theme/core/colors.json';
import { paper, varAlpha } from 'vrkit-app-renderer/theme/styles';
import { defaultFont } from 'vrkit-app-renderer/theme/core/typography';
import PRIMARY_COLOR from 'vrkit-app-renderer/theme/with-settings/primary-color.json';
