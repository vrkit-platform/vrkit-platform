...
import { faEye, faUser } from "@awesome.me/kit-79150a3eed/icons/duotone/solid"
...
export type SettingsTabbarProps = { setSelectedTabId:(id:string) => any, selectedTabId:string }
