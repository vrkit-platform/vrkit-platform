...
namespace IRacingTools::Shared::Services {
    ...
    class TelemetryDataService : public std::enable_shared_from_this<TelemetryDataService>, public Services::Service {
        public:            
             ...
             * @return
             */
            std::expected<const std::shared_ptr<TelemetryDataFile>,SDK::GeneralError> set(const std::shared_ptr<TelemetryDataFile> &config);

            std::expected<const std::shared_ptr<TelemetryDataFile>,SDK::GeneralError> set(const std::string& id, const std::shared_ptr<TelemetryDataFile> &config);
